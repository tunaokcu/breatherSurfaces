...
export default class Breather extends ParametricSurface{
    constructor(uStart=-4*Math.PI, uEnd=4*Math.PI, uDelta=60*Math.PI/360, vStart=-4*Math.PI, vEnd=4*Math.PI, vDelta=60*Math.PI/360, aa = 0.5){
...
function breatherDenom(aa, w, u, v){
    //NOTE! X AND Y MEAN NOTHING HERE 
...
//TODO RANGE u and v between -PI and PI